...
class Stats extends Component {
  ...
  render() {
    return (
        <div className="stats">
        <b className="debatenowhead" onClick={this.handleClick}><a href="diplomatica.vercel.app" onClick={this.handleClick}><u>My Recent Statistics</u></a></b><span role="img" aria-label="emoji"> 📊</span>       
