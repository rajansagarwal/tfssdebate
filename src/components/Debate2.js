...
class Debate2 extends Component {
  render() {
    return (
        ...
        <b className="debatenowhead"><Link to='/'>The Canadian Election</Link></b><span role="img" aria-label="emoji"> 🇨🇦 🗳️</span>
        ...
        <Link to="/article2" className="waitingroom">Read The Article</Link><br/>
